  ...
  <div>
        ...
        <div class="flex justify-around items-center">
          ...
          <div>
            <button
              ...
              class="mt-3 bg-slate-600 text-white font-bold p-2 rounded-lg w-48 shadow-md text-lg"
            >
              Capture Screenshot
            </button>
          </div>
    ...
    >
      ...
      <div id="card2" class="">
        ...
        >
          <p class="mt-1 text-sm text-gray-500">
            Create new ticket based on BIM
          </p>
        </div>
      </div>
    </div>
    ...
    >
      <div class="bg-white p-4 rounded shadow relative">
        ...
        <div class="mt-2">
          ...
          <button
            @click="closeModal"
            class="bg-gray-400 text-black px-3 py-1 rounded ml-2"
          >
            Close
          </button>
        </div>
